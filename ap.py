...
def main():
    ...
    st.markdown(
        ...
        f'<img src="https://raw.githubusercontent.com/sultanmanzoor2023/ap.git/main/ik804.jpg" class="clickable-image" alt="Clickable Image">'
        f'</a>',
        unsafe_allow_html=True
    )
    ...
    with st.sidebar:
        ...
        **How it work?**
        ...
        This program work with auto & manual train models.

        If you want auto train AI model prediction go to instruction 2:

        If you want manually train your AI model go to instruction 1: 2:

        1: **Manual Train AI Model**

        - Click on model training tab.
        - Select coin, AI model & time period.
        - Click train model buuton.
        - Your model is train and ready for prediction.

        2: **Auto & Manual Train AI Model Prediction**

        - Click on price prediction tab.
        - Select coin, AI model & time period.
        - Click predict future price buuton.

        **WOW**.... You are in **🌌 future** now.
